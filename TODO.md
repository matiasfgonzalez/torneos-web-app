...
- [~] **Admin (vos):** cola de pagos ✅ ya existía (`/admin/pagos`, aprobación).
  ...
  - **Pendiente:** "ver como organización" / impersonar (cero código, solo mencionado acá) — sigue bloqueado en la práctica por N3 (hoy `/admin/torneos`, `/admin/equipos`, etc. no filtran por organización para ADMINISTRADOR, o sea que el admin ya ve todos los datos sin necesidad de "impersonar"; una impersonación real requiere que esos listados primero aprendan a scopearse por org). Abordarlo junto con N3.
