...
- [ ] **Falta de N12:** el **carnet digital con QR** (verificación anti-suplantación en la cancha) y la **política de privacidad** — obligatoria: la plataforma maneja DNI de menores y mayores (Ley 25.326), y todavía no existen `/terminos` ni `/privacidad` (ver A10).
