...
- [ ] **S3. Inscripción online de equipos (E:Alto):** flujo público — organizador publica torneo con cupos y fecha límite → delegados registran equipo + plantel → organizador aprueba/rechaza. Estados `INSCRIPCION` ya existen en el enum; falta el workflow. Opcional: cobro de inscripción con Mercado Pago.
  - [~] **Núcleo hecho en N13/N12 (2026-07-14):** el delegado ya inscribe su equipo a los torneos abiertos, la liga aprueba/rechaza con `RegistrationStatus`, y el plantel se carga con dedupe por DNI. **Falta de S3:** cupos máximos y fecha límite de inscripción en el torneo (hoy solo se controla con el estado `INSCRIPCION`), y el cobro opcional con Mercado Pago.
...
- [ ] **Falta de N12:** que el jugador **reclame su propia ficha** (registrándose con su DNI), vea sus stats agregadas de todas las ligas y su carnet digital con QR. La base ya está: la ficha es única y global. Falta el flujo de reclamo (con aprobación, igual que el delegado) y la política de privacidad.
