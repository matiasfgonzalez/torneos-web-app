  ...
  if (isEmpty) {
    return (
      <div className="text-center py-12">
        <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-brand/10 to-brand-2/10 flex items-center justify-center">
        ...
        <div className="flex items-center justify-center gap-4 text-sm font-semibold">
          <Link href="/torneos" className="inline-flex items-center gap-1 text-brand hover:text-brand-mid">
            Explorar torneos <ArrowRight className="w-3.5 h-3.5" />
          </Link>
          <Link href="/equipos" className="inline-flex items-center gap-1 text-brand hover:text-brand-mid">
            ...
            {tournaments.map((t) => (
              ...
              >
                <Link href={tournamentPublicPath(t)} className="flex items-center gap-3 min-w-0 flex-1 group">
                  ...
                  <span className="font-medium text-gray-900 dark:text-white truncate group-hover:text-brand transition-colors">
                    {t.name}
                  </span>
                </Link>
