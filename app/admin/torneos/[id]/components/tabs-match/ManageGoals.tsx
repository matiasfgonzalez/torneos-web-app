...
export default function ManageGoals({ match, onUpdate }: ManageGoalsProps) {
  ...
  // El pendiente de la transición hace de "cargando jugadores": no hace falta un
  // estado aparte que haya que apagar a mano en un finally.
  ...
  // Declarada ANTES del effect que la usa (si el `const` queda debajo, el effect
  // la lee en la zona muerta temporal: react-hooks/immutability) y con el fetch
  // dentro de una transición, para que el setState no quede en el cuerpo del
