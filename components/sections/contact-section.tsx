        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <FadeInSection direction="right">
            <div className="relative h-full">
              <div className="bg-white/10 dark:bg-gray-800/50 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-3xl p-8 shadow-2xl shadow-brand/5 h-full">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-8">
                  Envíanos un mensaje
                </h3>
                ...
                <form className="space-y-6">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        className="h-12 rounded-xl bg-white/50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-600 focus:border-brand focus:ring-brand/20"
                      />
                    </div>
                    <div>
                      <label
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      className="rounded-xl bg-white/50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-600 focus:border-brand focus:ring-brand/20 resize-none"
                    />
                  </div>

                  <GradientButton
                    type="submit"
                    className="w-full h-auto min-h-12 py-4 text-lg shadow-lg shadow-brand/25"
                  >
