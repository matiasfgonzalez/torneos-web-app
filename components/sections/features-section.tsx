            ...
            return (
              <StaggerItem key={index}>
                <div className="group relative h-full">
                  {/* Wrapper para el borde gradiente */}
                  <div className="relative h-full rounded-3xl p-[1px] transition-all duration-500 hover:-translate-y-2 bg-gray-100 dark:bg-gray-700/50 hover:bg-gradient-to-br hover:from-brand hover:to-brand-2 hover:shadow-2xl hover:shadow-brand/20">
                    {/* Card con efecto glassmorphism */}
                    <div className="relative h-full p-8 rounded-3xl bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-800/50 overflow-hidden">
                      ...
                      {/* Acá había un "Saber más" con flecha que aparecía al
                          pasar el mouse y no llevaba a ningún lado: un `<div>`
                          sin href ni handler. Se sacó en vez de inventarle un
                          destino — la tarjeta describe la función y el CTA de
                          la sección ya está abajo. */}
